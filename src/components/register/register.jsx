    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                `http://localhost:8009/api/auth/send-otp?email=${encodeURIComponent(email)}`,
                {
                    method: "POST",
                    headers: {
                        "accept": "*/*",
    ...
    return (
        <div className="bg-white p-6 rounded-xl shadow-lg flex w-full max-w-4xl min-h-[500px] relative z-20">
            ...
            <div className="w-full md:w-1/2 p-6">
                ...
                <h3 className="text-xl font-bold mb-4 text-black text-center">Register an account</h3>
                <p className="text-center text-gray-500 mb-3">Please enter your email address to receive the verification code</p>
